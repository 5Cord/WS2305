...
<body>
    ...
    <a href="#navbarNav">
        <div class="ontop_btn ontop_btn_0ff"> Наверх</div>
    </a>
        ...
        <div class="swiper-wrapper swiper_image">
            ...
            ?>
                <div class="swiper-slide">
                    <img class="bg_swiper" src="images/OKompanii.jpg" alt="AboutKompany">
                    <div class="block_swiper">
                        ...
                        <div class="picutres"><img src=images/history/<?php echo $news["pictures"] ?> alt="HistoryImage"></div>
                    </div>
